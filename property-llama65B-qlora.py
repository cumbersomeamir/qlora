...
#Loading the Dataset
data = load_dataset("Amirkid/1UID-11VARS-10MUTATIONS")
...
username = "Amirkid"
model_name = "Property-llama65B-Qlora"
...
model.push_to_hub("Amirkid/property-llama65B-Qlora", use_auth_token = token)
